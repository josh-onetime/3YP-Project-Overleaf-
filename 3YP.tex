...
\begin{document}
	...
	\section{Product Hardware - ENG}
		...
		\subsubsection{Rotary Sensors}
            ...
            \tableref{rotary_encoders_comparison} compares them. 
            MR is the magnetoresistance ratio and it describes how sensitive the sensor is to changing its electrical resistance with changes in external magnetic fields.\supercite{magnetoresistance} From \tableref{rotary_encoders_comparison} and \figref{rotary_encoders_graph} it can be seen that TMR sensors are the most sensitive.
            \\
