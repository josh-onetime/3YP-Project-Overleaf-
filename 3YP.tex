...
\begin{document}
	...
	\section{Stakeholder Analysis}
     ...
     \section[Business Risk Assessment]{Business Risk Assessment - Jim Laney}
     	...
     	As well as this, gas networks are considered to be at fault if a third party causes damage, if it can be shown that they have not "exercised all due diligence"\textsuperscript{\cite{books1996guide}}, and as such it is imperative that the robot conforms to all regulations strictly.
     	...
     	This problem is further exacerbated by the fact that other markets, such as the United States, have regulations and standards which differ between states\textsuperscript{\cite{pless2011making}}.
     	\\
