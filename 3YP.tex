...
\end{enumerate}
	...
	\section[Product-Market Fit - EEM]{Product-Market Fit - Jim Laney}
		...
		In order to consider how well our product fits the market needs, issues gathered from our primary and secondary research into the industry were considered, and how the robot solves these is shown below.
		...
		\begin{longtable}[c]{| m{0.45\textwidth} | m{0.45\textwidth} |}
			...
			As well as this, for safety reasons the gas must be turned off, reducing the uptime of the network and incurring a loss for the gas company, which is made even more serious by the fact that manual inspection is slow.
			& 
			Our robot only requires a small excavation, since the launch tube is much smaller, and can operate within an active gas pipe. 
			...
			Autonomous in pipe inspection is also faster due  to the robotic nature of the inspection technology. and human error is greatly reduced.
			\\
			\hline
