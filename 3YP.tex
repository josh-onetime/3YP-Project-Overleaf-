...
\end{enumerate}
	...
	\section{Product Software - ENG}
        ...
        \\
         [https://www.researchgate.net/publication/260006092_Corrosion_Detection_for_Automated_Visual_Inspection]
        \\
...
\begin{figure}[h]
    ...
    \supercite{CrackGAN}
	 \supercite{CrackGAN1}
        ...
        YOLOv3 is made of a feature detector called Darknet-53 which consists of 53 convolutional layers which are of sizes 3x3 and 1x1 and then 53 detector layers, followed by a detection neural network. \supecite{YOLOV3}
	...
	\section{Industry Analysis - EEM}
		...
		\subsection[P5F: Threat of New Entry]{Threat of New Entry}
				
		\subsection[P5F: Power of Suppliers]{Power of Suppliers - Jim Laney}
		...
		\subsection[P5F: Power of Buyers]{Power of Buyers}
		
		\subsection[P5F: Threat of Substitutes]{Threat of Substitutes - Jim Laney}
		...
		\subsection[P5F: Rivalry Among Existing Competitors]{Rivalry Among Existing Competitors - Louis Emanuel}
